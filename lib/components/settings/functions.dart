...
Widget textInstructions(String text, BuildContext context) {
  return Text(
    text,
    style: TextStyle(
      color: Colors.white,
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            textInstructions("🔘  If the directions you're swiping have a wall, you won't be able to swipe the doctor.", context),
                            const SizedBox(
                              height: 10,
                            ),
                            Container(
                            ...
                            textInstructions("🔘  If the directions you’re swiping have a apray, you get ${GameConfig.spraysInBox} sprays", context),
                            const SizedBox(
                              height: 10,
                            ),
                            Container(
                            ...
                            textInstructions(
                                "If the directions you’re swiping have a covid, You have to use your sprays to get rid of them.\n"
